/*
  ...
  Source of truth: src/data/tier1Catalog.js (44 products, 96 dosage variants),
  ...
  for (const p of c.products) {
    p.variants.forEach((v, i) => {
      ...
      for (const t of TIERS) {
        const unit = ladderPrice(price, t.mult);
        tierRows.push(
