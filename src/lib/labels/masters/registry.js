...
export const TEMPLATE_MASTERS = {
  "noir-clinical-core": {
    ...
    fields: {
      ...
      composition: {
        box: { x: 74, y: 298, w: 232, h: 58 },
        patch: { type: "solid", color: "#0b0d10" },
        x: 76,
        firstBaseline: 312,
        leading: 19,
        maxLines: 2,
        font: { size: 14, min: 11, rowMin: 9.5, weight: 400, color: "#dfe5ea", spacing: 0.1 },
      },
      lot: {
  ...
  "cryogenic-white": {
    ...
    fields: {
      ...
      composition: {
        box: { x: 120, y: 386, w: 264, h: 56 },
        patch: { type: "sample", src: { x: 120, y: 20, w: 264, h: 24 } },
        x: 123,
        firstBaseline: 400,
        leading: 21,
        maxLines: 2,
        font: { size: 17.5, min: 14, rowMin: 9.5, weight: 400, color: "#2b3a55", spacing: 0.1 },
      },
      lot: {
      ...
      barcodeText: {
        box: { x: 1458, y: 148, w: 52, h: 216 },
        patch: { type: "sample", src: { x: 1458, y: 380, w: 52, h: 80 } },
        cx: 1490,
        cy: 255,
