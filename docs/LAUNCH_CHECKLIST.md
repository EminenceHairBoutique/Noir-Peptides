...
- [ ] §1 ledger check in `docs/RUNBOOK.md` reports every migration applied
      (0025 / 0028 / 0029 true).
- [ ] Migrations **0030–0041** applied and verified (Owner Sprint D2 green) — follow
...
- [ ] Vercel env has: Supabase trio, Stripe trio (+ `PAYMENTS_STRIPE_LIVE_ACK` with a live key),
